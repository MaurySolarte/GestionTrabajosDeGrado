...
public class ServicioUsuarioTest {
    ...
    public void testListarProfesores() {
        ...
        ServicioUsuario instance = new ServicioUsuario(repository);
        int expResult = 0;
        List<Profesor> result = instance.listarProfesores();
        assertNotEquals(0, result.size());
    }

    @Test
    public void testActualizarEstadoEstudiantePorCorreo() {
        System.out.println("actualizarEstadoEstudiantePorCorreo");
        String correo = "nelsonl2v@unicauca.edu.co";
        String nuevoEstado = "PrimerRevision";
        IRepositorioUsuario repository = new RepositorioUsuario();
        ServicioUsuario instance = new ServicioUsuario(repository);
        boolean expResult = true;
        boolean result = instance.actualizarEstadoEstudiantePorCorreo(correo, nuevoEstado);
        assertEquals(expResult, result);
    ...
    public void testRegistrarUsuario1() throws Exception {
        ...
        Usuario nuevoUsuario = new Usuario("Nelson Rodrigo", "Lopez Vidales","3216169841", EnumProgramas.Ingeniería_de_Sistemas, EnumRoles.Estudiante, "ainaraazumendi@unicauca.edu.co", "Nelson123?");
        IRepositorioUsuario repository = new RepositorioUsuario();
        ServicioUsuario instance = new ServicioUsuario(repository);
    ...
    public void testIniciarSesion() {
        ...
        String email = "nelsonl2v@unicauca.edu.co";
        String contrasenia = "Nelson12?";
        IRepositorioUsuario repository = new RepositorioUsuario();
        ServicioUsuario instance = new ServicioUsuario(repository);
        int expResult = 1;
    ...
    public void testObtenerUsuarioPorEmail() {
        ...
        IRepositorioUsuario repository = new RepositorioUsuario();
        ServicioUsuario instance = new ServicioUsuario(repository);
        Usuario expResult = new Usuario("Nelson Rodrigo", "Lopez Vidales","3216169841", EnumProgramas.Ingeniería_de_Sistemas, EnumRoles.Estudiante, "nelsonl2v@unicauca.edu.co", "Nelson12?");
    ...
    @Test
    public void testObtenerEstudiantePorCorreo() {
        System.out.println("obtenerEstudiantePorCorreo");
        String email = "nelsonl2v@unicauca.edu.co";
        IRepositorioUsuario repository = new RepositorioUsuario();
        ServicioUsuario instance = new ServicioUsuario(repository);
        Estudiante expResult = new Estudiante("Nelson Rodrigo", "Lopez Vidales","3216169841", EnumProgramas.Ingeniería_de_Sistemas, EnumRoles.Estudiante, "nelsonl2v@unicauca.edu.co", "Nelson12?", "Test");
        Estudiante result = instance.obtenerEstudiantePorCorreo(email);
        assertEquals(expResult.getNombres(), result.getNombres());
        assertEquals(expResult.getApellidos(), result.getApellidos());
        assertEquals(expResult.getCelular(), result.getCelular());
        assertEquals(expResult.getPrograma(), result.getPrograma());
    ...
    @Test
    public void testObtenerProfesorPorNombre() {
        System.out.println("obtenerProfesorPorNombre");
        String nombreCompleto = "Erwin Meza";
        IRepositorioUsuario repository = new RepositorioUsuario();
        ServicioUsuario instance = new ServicioUsuario(repository);
        Profesor expResult = new Profesor("Erwin", "Meza","3212344312", EnumProgramas.Ingeniería_de_Sistemas, EnumRoles.Profesor, "emezav@unicauca.edu.co", "test", null);
        Profesor result = instance.obtenerProfesorPorNombre(nombreCompleto);
        assertEquals(expResult.getNombres(), result.getNombres());
        assertEquals(expResult.getApellidos(), result.getApellidos());
        assertEquals(expResult.getCelular(), result.getCelular());
        assertEquals(expResult.getPrograma(), result.getPrograma());
